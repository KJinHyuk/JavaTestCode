...
public class RandomMainClass {
	public static void main(String[] args) {
		...
		int UserBall = 10;			// 각각 선수에게 지급되는 구슬 갯수
		int ComBall = 10;			// 각각 선수에게 지급되는 구슬 갯수
		String UserResult;			// 사용자의 홀 짝 저장값
		String ComResult;			// B선수의 홀 짝 저장값
		Scanner Pp = new Scanner(System.in);			//참가자수 받기위한 sc 선언
		...
		int z = Pnum / 2;
		System.out.println("다음 라운드 진출자는 총 " + z + "입니다.");
	}// Main
}// Class